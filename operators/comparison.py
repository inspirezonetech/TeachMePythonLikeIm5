...
# So basically there are 6 Comparision Operators in Python , let us learn them one by one .
# One more thing to note is that whenever you compare two "things" , the return value of this Comparision will be either True or False
...
a = 3
b = 5
print(a<=b) # Here since a is less than b ,  we will get True inoutput.
