...
# In this aspect, there are more assignment operators that pretend to shorten a
# small operation on the variable and then an assignment to itself. As an
# example, the following line will do the same as the one above:
var += 2  # var = var + 2
...
# -----------------------------------------------------------------------------
# Challenge: list challenges to be completed here. minimum of one challenge per
# tutorial
# -----------------------------------------------------------------------------
