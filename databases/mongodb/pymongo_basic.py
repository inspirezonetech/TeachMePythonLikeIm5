# ------------------------------------------------------------------------------------
"""
This tutorail is about to getting started with MongoDB using Python.
There is a module for Pymongo for the same.
...
print(collection)
# ------------------------------------------------------------------------------------
# Challenge: Try Creating a Database and Collection with follwing.
# "yourname_database/collection" using some remote host.
# ------------------------------------------------------------------------------------
